...
// Backwards-compatibility macros: map original REF function names to renamed symbols
#define writeReg Write_Reg
#define writeReg16Bit Write_Reg16Bit
#define writeReg32Bit Write_Reg32Bit
#define readReg Read_Reg
#define readReg16Bit Read_Reg16Bit
#define readReg32Bit Read_Reg32Bit
#define writeMulti Write_Multi
#define readMulti Read_Multi
#define getSpadInfo Get_Spad_Info
#define getSequenceStepEnables Get_Sequence_Step_Enables
#define getSequenceStepTimeouts Get_Sequence_Step_Timeouts
#define performSingleRefCalibration Preform_Single_Ref_Calibration
#define decodeTimeout Decode_Timeout
#define encodeTimeout Encode_Timeout
#define timeoutMclksToMicroseconds Timeout_Mclks_To_Microseconds
#define timeoutMicrosecondsToMclks Timeout_Microseconds_To_Mclks
#define setSignalRateLimit Set_Signal_Rate_Limit
#define getSignalRateLimit Get_Signal_Rate_Limit
#define setMeasurementTimingBudget Set_Measurement_Timing_Budget
#define getMeasurementTimingBudget Get_Measurement_Timing_Budget
#define setVcselPulsePeriod Set_Vcsel_Pulse_Period
#define getVcselPulsePeriod Get_Vcsel_Pulse_Period
#define startContinuous Start_Continuous
#define stopContinuous Stop_Continuous
#define readRangeContinuousMillimeters Read_Range_Continuous_Millimeters
#define readRangeSingleMillimeters Read_Range_Single_Millimeters
#define timeoutOccurred Timeout_Occurred
#define setTimeout Set_Timeout
#define getTimeout Get_Timeout
#define setAddress_VL53L0X Set_Address_VL53L0X
#define getAddress_VL53L0X Get_Address_VL53L0X
#define initVL53L0X Init_VL53L0X
...
bool Preform_Single_Ref_Calibration(uint8_t vhv_init_byte);
...
// mode.
bool Init_VL53L0X(bool io_2v8, I2C_HandleTypeDef *handler){
  ...
  g_measTimBudUs = Get_Measurement_Timing_Budget();
  ...
  Set_Measurement_Timing_Budget(g_measTimBudUs);
  ...
  if (!Preform_Single_Ref_Calibration(0x40)) { return false; }
  ...
  if (!Preform_Single_Ref_Calibration(0x00)) { return false; }
